...
import com.startup.paynchat.activities.ActivityIntro;

public class AppIntroPagerAdapter extends PagerAdapter {
    private Context mContext;
    private LayoutInflater mLayoutInflater;
    private int[] mResources;
    private ActivityIntro activity;

    public AppIntroPagerAdapter(ActivityIntro appIntroActivity, Context mContext, int[] mResources) {
