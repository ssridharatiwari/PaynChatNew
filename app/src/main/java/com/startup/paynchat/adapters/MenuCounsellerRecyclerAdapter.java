...
public class MenuCounsellerRecyclerAdapter extends RecyclerView.Adapter<MenuCounsellerRecyclerAdapter.BaseViewHolder> implements Filterable {
    ...
    public MenuCounsellerRecyclerAdapter(@NonNull Context context, @Nullable ArrayList<User> users) {
    ...
    public BaseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new UsersViewHolder(LayoutInflater.from(context).inflate(R.layout.item_counsellers, parent, false));
    }
...
//                        context.startActivity(it);
        ...
        public void setData(User user) {
            ...
            Glide.with(context).load(user.getImage()).apply(new RequestOptions().placeholder(R.drawable.y_placeholder)).into(userImage);
