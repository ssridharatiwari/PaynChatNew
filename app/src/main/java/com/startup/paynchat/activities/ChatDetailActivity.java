...
import com.startup.paynchat.fragments.ChatDetailFragment;
import com.startup.paynchat.fragments.UserMediaFragment;
import com.startup.paynchat.interfaces.GroupModificationListener;
...
import com.startup.paynchat.services.SendMessageService;
import com.startup.paynchat.utils.FirebaseUploader;
import com.startup.paynchat.utils.GeneralUtils;
...
//        }
        ...
        Glide.with(this).load(chat.getChatImage()).apply(new RequestOptions().placeholder(R.drawable.y_placeholder)).into(userImage);
