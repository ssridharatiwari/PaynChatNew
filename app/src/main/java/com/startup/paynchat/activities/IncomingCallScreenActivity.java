...
//            }
            ...
            user = user = new User(
                    PreferenceConnector.readString(this, PreferenceConnector.LOGINEDPHONE, ""),
                    PreferenceConnector.readString(this, PreferenceConnector.LOGINEDNAME, ""),
                    "",
                    "",
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (mContext != null) {
                            ...
                            if (userIn != null) {
                                ...
                                Glide.with(mContext).load(user.getImage()).apply(new RequestOptions().placeholder(R.drawable.y_placeholder)).into(userImage1);
                                Glide.with(mContext).load(user.getImage()).apply(RequestOptions.circleCropTransform().placeholder(R.drawable.y_placeholder)).into(userImage2);
                            }
                        }
                    }
            ...
            TextView callingType = findViewById(R.id.paynchat_calling);
    ...
    private void answerClicked() {
        ...
        if (call != null) {
            try {
                ...
                CallScreenActivity.userInOut = "IN";
                CallScreenActivity.userCallId = mCallId;
                startActivity(CallScreenActivity.newIntent(this, user, mCallId, "IN", CallScreenActivity.MAXCALLTIMEINSEC));
                finish();
            } catch (Exception e) {
...
//                    helper.getMyContacts();
                    user = new User(call.getRemoteUserId(), (user.getName()), getString(R.string.app_name), "", "");
                }
